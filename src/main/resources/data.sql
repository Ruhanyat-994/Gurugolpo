...
INSERT INTO users (email, username, password, university, role, is_active) VALUES
('admin@university.edu', 'admin', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDi', 'System Admin', 'ADMIN', TRUE);
...
-- Insert sample universities and users for testing
INSERT INTO users (email, username, password, university, role, is_active) VALUES
